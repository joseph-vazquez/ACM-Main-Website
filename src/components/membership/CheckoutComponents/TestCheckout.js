 ...
 * The stripe function uses ACM web email
 * 
 ******************************/
...
const stripePromise = loadStripe(
  "pk_test_51NRHOmA1svxp0CDK1JsUPikjdzZhiWl2NmKF4yWX70LIVUiZeSjNGpgkPASLAhUZwFDvZCbzJ7KLzlPLy3BiLL2k00WG0X1SvR"
);
...
const TestCheckout = () => {
  const [state, dispatch] = useReducer(reducer, {
    priceId: "price_1NRHUjA1svxp0CDKwARHLFl2",
    basePrice: "5.50",
    currency: "USD",
    quantity: 1,
    price: formatPrice({
